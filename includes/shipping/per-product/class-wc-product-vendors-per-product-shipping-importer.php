...
if ( class_exists( 'WP_Importer' ) ) :
	class WC_Product_Vendors_Per_Product_Shipping_Importer extends WP_Importer {
		...
		public function import( $file ) {
			...
			// Show Result
			echo '<div class="updated settings-error below-h2"><p>' . sprintf( esc_html__( 'Import complete - imported <strong>%s</strong> shipping rates and skipped <strong>%s</strong>.', 'woocommerce-product-vendors' ), $this->imported, $this->skipped ) . '</p></div>';
